<?php if(config('sweetalert.alwaysLoadJS') === true || Session::has('alert.config') || Session::has('alert.delete')): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\Kuliah\Semester 4\Pemrograman Framework\Praktikum 9\Praktikum-Modul-9-main\vendor\realrashid\sweet-alert\src/../resources/views/alert.blade.php ENDPATH**/ ?>